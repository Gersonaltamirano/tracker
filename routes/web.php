...
Route::get('/gps-tracker/export', [App\Http\Controllers\dashboard\GPSTrackerController::class, 'exportData'])->name('gps-tracker-export');
Route::get('/gps-tracker/statistics', [App\Http\Controllers\dashboard\GPSTrackerController::class, 'getStatistics'])->name('gps-tracker-statistics');
